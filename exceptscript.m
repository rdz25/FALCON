load(['DownloadedTissueSpecific' filesep 'mCADREFiles' filesep 'ovary_tumor.mat']);
...
for i=1:length(mA)
    ...
    excrxnind=find(strcmp(excrxnname,ovary_tumor.rxns));
...
%     check=regexp(ovary_tumor.rxns,trimmet);    %regexp has loosest definitions of a match, glyc matches w/ EX_glyc_S(e), dunno if that's ok
